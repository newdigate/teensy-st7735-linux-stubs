...
GLuint st7735_opengl::shader_program;
GLuint st7735_opengl::vertex_shader;
GLuint st7735_opengl::fragment_shader;
GLuint st7735_opengl::texture;
int16_t st7735_opengl::_frameSize;
unsigned int st7735_opengl::VBO;
